...
import { CHARITY_BADGES, CHARITY_BADGES_STORE, ECO_BADGES, GENERAL_BADGES } from './data'
  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="w-full max-w-7xl mx-auto px-4 py-12 space-y-16">
        ...
        {/* Charity Store Badges */}
        <section>
          <BadgeGrid badges={CHARITY_BADGES_STORE} title="Charity Store Badges" />
        </section>
        ...
        {/* Charity Badges */}
        <section>
          <BadgeGrid badges={CHARITY_BADGES} title="Charity Badges" />
        </section>
      </main>
    </div>
  )
