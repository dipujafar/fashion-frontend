...
import AddAnsForm from './AddAnsForm';


const ReviewContainer = async ({ quesPromise, prodId }: { quesPromise: Promise<{ data: { data: IQuesAns[], isOwner: boolean } }>, prodId: string }) => {
                                ...
                                >
                                    ...
                                    <div className="flex-shrink-0">
                                        ...
                                        {(questions?.data?.isOwner && !comment?.answer) && <Popover>
                                            ...
                                            <PopoverContent>
                                                <AddAnsForm questionId={comment?.id} prodId={prodId} />
                                            </PopoverContent>
                                        </Popover>}
                                    </div>
                                </div>
