  ...
  return (
    <div className="grid grid-cols-2 md:gap-4 gap-2 md:grid-cols-4">
      {productCategoryData.map((productCategory) => (
        ...
        >
          <Button className="absolute lg:bottom-3 bottom-2 left-1/2 -translate-x-1/2 uppercase bg-primary-white text-primary-black rounded border-b-3 border-r-3 border-primary-red xl:px-12 lg:px-8 px-7 hover:text-primary-light-pink font-bold">
