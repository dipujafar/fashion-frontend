...
const navLinks = [
  {
    ...
    href: "/assisted-seller/dashboard/profile",
  },
  {
    _id: 2,
    title: "Products Listing",
    href: "/assisted-seller/dashboard/products-list",
  },
  {
    _id: 5,
    title: "Settings",
...
const AssistedSellerTopBarSection = () => {
  ...
  return (
    <div className="max-h-[240px] relative">
      ...
      ></Image>
      <div
        className="max-w-xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:px-8 lg:py-4 md:px-6 px-2 py-5 text-primary-white lg:text-5xl md:text-3xl text-xl font-semibold text-center w-full md:backdrop-blur-[7px] backdrop-blur-[4px] rounded-lg"
        style={{
...
export default AssistedSellerTopBarSection;
