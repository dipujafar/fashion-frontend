...
const ProfessionalSellerProfileForm = () => {
              ...
              <div className="md:space-y-6 space-y-4 md:mt-20 mt-14 ">
                ...
                <div>
                  ...
                  {document?.map((doc, index) => (
                    <div
                      key={index}
                      className="bg-[#F2F0F0] mt-3 flex items-center justify-between gap-x-2 px-3 py-2 rounded-xl"
                      style={{ boxShadow: "0 4px 10px 0 rgba(0, 0, 0, 0.11)" }}
                    >
                      <div className="flex items-center gap-x-2">
                        <DocumentIcon className="w-10 h-10 text-black" />
                        <h4 className="text-[#000]">{doc}</h4>
                      </div>
                      <Trash2
...
export default ProfessionalSellerProfileForm;
