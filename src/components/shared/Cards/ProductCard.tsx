        ...
        <div className="relative">
          <div className="relative group">
            ...
            <div
              ...
              className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-black/40 flex justify-center items-center  transform scale-y-0 group-hover:scale-y-100 transition-all duration-700 origin-top cursor-pointer"
            >
              <div className="space-y-2">
                <Link href={`/shop/${data?.id}`} className="block">
          ...
          {!ownProduct && (
            <div className="flex items-center gap-x-1 gap-y-1 justify-between">
              ...
              <div
                ...
                style={{ backgroundColor: userTagColor(data?.user?.auth?.role) }}
              >
