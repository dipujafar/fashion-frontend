...
function SizeSelectorInner({
    ...
    const filtered = search.trim()
        ? sizes.filter((s) => s.title.toLowerCase().includes(search.toLowerCase()))
        : sizes;
            ...
            >
                ...
                >
                    <span className={selectedSize ? "text-foreground" : "text-muted-foreground"}>
                        {selectedSize ? selectedSize.title : placeholder}
                    </span>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between px-4 py-3 border-b border-border shrink-0">
                                <div className="w-7" />
                                <span className="font-semibold text-base text-foreground">Size</span>
                                <button
                                    type="button"
                                    onClick={closePanel}
